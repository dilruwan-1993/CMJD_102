...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnListIssuedBooks.setText("List Ordered Products");
        btnListIssuedBooks.show(false);
        ...
        btnIssueBook.setText("Order Product");
        ...
        btnSearchBook.setText("Search Product");
        ...
        btnListBooks.setText("List all Products");
        ...
        btnAddBook.setText("Add Product");
        ...
        comboBoxSearchBy.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Name", "Category", "Supplier", "ID" }));
        ...
        searchTable.setModel(new DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Product Name", "Category", "Quantity", "Supplier"
            }
        ) {
        ...
        bookAuthorTable.setModel(new DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Name", "Category", "Quantity", "Supplier Name"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
        ...
        bookAuthorTable.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
        ...
        scrollPaneBookAuthor.getAccessibleContext().setAccessibleName("scrollPaneBookSupplier");
        ...
        ComboBoxSearchBook.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Name", "Category", "Supplier", "ID" }));
        ...
        searchBookLabel.setText("Search Product");

        searchStudentLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        searchStudentLabel.setText("Search Customer :");
        ...
        btnAddStudent.setText("Add Customer");
        ...
        issuedBooksTable.setModel(new DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Issue ID", "Product Name", "ID", "Student Name", "Issue Date", "Return Date", "Product ID"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        returnTodayTable.setModel(new DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Issue ID", "Product Name", "ID", "Issue Date", "Return Date", "Product ID"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        comboBoxCategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Primary", "Secondary" }));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if(searchBy == null)
        {
            searchBy = "Name"; //search by title default
        }
        ...
        switch(searchBy)
        {
            ...
            case   "Supplier":    searchTable.setModel(dao.getBySupplier(txt));
                                break;

            case     "ID":    searchTable.setModel(dao.getById(Integer.parseInt(txt)));
                                break;
        }
    ...
    private void btnSearchBookIssueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchBookIssueActionPerformed
        ...
        {
            searchBookBy = "Name"; //search by title default
        }
        ...
        switch(searchBookBy)
        {
            case    "Name":    bookTable.setModel(dao.getByName(txt));
                                break;

            case "Category":    bookTable.setModel(dao.getByCategory(txt));
                                break;

            case   "Supplier":    bookTable.setModel(dao.getBySupplier(txt));
                                break;

            case     "ID":    bookTable.setModel(dao.getById(Integer.parseInt(txt)));
                                break;
        }
...
//        }
    ...
    private void btnListBooksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListBooksActionPerformed
       ...
       bookAuthorTable.setModel(dao.getTableProductSupplier());
...
//       returnTodayTable.setModel(dao.getBookToReturn(curDate));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(title.equals("") || category.equals("") || name.equals("") || email.equals("") || q.equals(""))
        {
        ...
        if( dao.add(new Product(isbn, title, category, numBooks)) && dao.addSupplier(new Supplier(name, email, isbn)) )
        {
    ...
    private void btnSearchBookIssue1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchBookIssue1ActionPerformed
        int usn = Integer.parseInt(txtUsnSearch.getText().trim());

        if(true)
        {
            studentTable.setModel(dao.getCustomerById(usn));
        }
        else
        {
	...
	{
            JOptionPane.showMessageDialog(panelIssueBook, "Please select Product and Customer from the table", "Invalid Operation", JOptionPane.ERROR_MESSAGE);
            return;
	}
        int usn = Integer.parseInt((String)studentTable.getModel().getValueAt(idxStudent, 0));
        String name = (String)studentTable.getModel().getValueAt(idxStudent, 1);
        int isbn = Integer.parseInt((String)bookTable.getModel().getValueAt(idxBook, 0));
	...
	Date return_date = cal.getTime();
        if( (dao.customerExist(new Customer(usn, name)) || dao.addCustomer(new Customer(usn, name))) && dao.orderProduct(new Order(usn, issue_date, isbn)) )
	{
            JOptionPane.showMessageDialog(panelIssueBook, "Order placed Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
            idxBook = -1;
            bookTable.setModel(new DefaultTableModel());
	}
        else
    ...
    private void btnSearchByUsnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchByUsnActionPerformed
        ...
        if(usn.length() == 0)
        {
            JOptionPane.showMessageDialog(panelIssueBook, "Please enter usn", "Invalid ID", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private JTable bookAuthorTable;
    ...
    private JTable returnTodayTable;
